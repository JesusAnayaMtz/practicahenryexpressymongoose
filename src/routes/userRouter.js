...
userRouter.post("/", validate.validateUser, userController.createUser) // Agregamos una ruta para crear un usuario y agregamos el middleware validateUser
...
userRouter.get("/:id", validate.validateId,userController.getUSerById); // Agregamos una ruta para obtener un usuario por ID
